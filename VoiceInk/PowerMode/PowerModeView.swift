...
enum ConfigurationMode: Hashable {
    ...
    var title: String {
        switch self {
        case .add: return String(localized: "Add Power Mode")
        case .edit: return String(localized: "Edit Power Mode")
        }
    }
                                        ...
                                        VStack(spacing: 24) {
                                            ...
                                            VStack(spacing: 16) {
                                                ...
                                                VStack(spacing: 8) {
                                                    ...
                                                    Text("Create first power mode to automate your Voco workflow based on apps/website you are using")
                                                        .font(.system(size: 14))
                                                        .foregroundColor(.secondary)
