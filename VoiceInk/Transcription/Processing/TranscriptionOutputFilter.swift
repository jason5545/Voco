...
struct TranscriptionOutputFilter {
    private static let logger = Logger(subsystem: AppIdentifiers.subsystem, category: "TranscriptionOutputFilter")
    private static let lowercaseTranscriptionKey = "LowercaseTranscription"
    private static let apostropheLikeCharacters = CharacterSet(charactersIn: "'\u{2019}\u{2018}\u{02BC}\u{FF07}")
