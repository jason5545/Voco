...
struct MetricsContent: View {
    ...
    private var accessibilityPermissionCallout: some View {
        PermissionCard(
            ...
            description: "Voco needs Accessibility permission to work reliably across your entire Mac",
            isGranted: isAccessibilityEnabled,
            buttonTitle: "Open System Settings",
            buttonAction: openAccessibilitySettings,
            checkPermission: refreshAccessibilityStatus,
            infoTipMessage: "Voco uses Accessibility to work reliably across apps."
        )
    }
