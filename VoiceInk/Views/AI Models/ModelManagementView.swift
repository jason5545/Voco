...
struct ModelManagementView: View {
    ...
    private var filteredModels: [any TranscriptionModel] {
        ...
        case .local:
            return transcriptionModelManager.allAvailableModels.filter { $0.provider == .local || $0.provider == .nativeApple || $0.provider == .parakeet || $0.provider == .qwen3 || $0.provider == .whisperMLX }
        case .cloud:
