    ...
    private var filteredModels: [any TranscriptionModel] {
        ...
        case .recommended:
            return whisperState.allAvailableModels.filter {
                let recommendedNames = ["ggml-base.en", "parakeet-tdt-0.6b-v2", "ggml-large-v3-turbo-q5_0", "whisperkit-large-v3-turbo", "whisper-large-v3-turbo"]
                return recommendedNames.contains($0.name)
            }.sorted { model1, model2 in
                let recommendedOrder = ["ggml-base.en", "parakeet-tdt-0.6b-v2", "ggml-large-v3-turbo-q5_0", "whisperkit-large-v3-turbo", "whisper-large-v3-turbo"]
        ...
        case .local:
            return whisperState.allAvailableModels.filter {
                if SystemArchitecture.isIntelMac && ($0.provider == .qwen3 || $0.provider == .whisperKit) { return false }
                return $0.provider == .local || $0.provider == .nativeApple || $0.provider == .parakeet || $0.provider == .qwen3 || $0.provider == .whisperKit
            }
        case .cloud:
