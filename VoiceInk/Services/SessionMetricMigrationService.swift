            ...
            do {
                ...
                for transcription in transcriptions {
                    ...
                    let metric = SessionMetric(
                        ...
                        reviewTriggerCount: SessionMetric.reviewTriggerCount(from: transcription.reviewTriggers),
                        reviewTriggerIDs: SessionMetric.reviewTriggerIDs(from: transcription.reviewTriggers),
                        reviewTriggerSummaries: SessionMetric.reviewTriggerSummaries(from: transcription.reviewTriggers),
