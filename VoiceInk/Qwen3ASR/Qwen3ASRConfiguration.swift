...
/// Tunables for the decoder token-selection step.
///
/// Defaults apply a mild repetition penalty (1.1) to discourage the decoder
/// from collapsing onto a single token on silence or ambiguous phonemes.
struct Qwen3DecodingOptions: Sendable {
    /// HuggingFace-style repetition penalty. Divides the logits of tokens
    /// already generated by this factor before selection.
